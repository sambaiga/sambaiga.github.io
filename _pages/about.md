...
I am also a PhD research at Further Energy and Environment research Laboratory (FEELab), at [ITI/LARSyS](https://iti.larsys.pt/larsys/), [Técnico Lisboa](https://tecnico.ulisboa.pt/en/) in Portugal under [Prof Nuno Jardim Nunes](http://nunonunes.info/) and [Dr. Lucas Pereira](https://www.alspereira.info/) supervision. My  research focus on developing robust machine learning algorithms for industrial applications with a specific focus on future energy systems.
...
4. Artificial Intelligence and Earth Observations(EO)  for suistainability  focusing on sustainable energy, agriculture and natural resources management.
