...
{% include youtube.html content="https://youtu.be/fF-k0gE7apI" %}
The project develops IoT and Big Data flexible platform to provide data-driven solutions to solve common maintenance challenges, with a special focus on predictive maintenance, for a wide range of machines. For more details visit the [project page](https://imr.ie/pages/data-driven-maintenance-service-ddms/)
