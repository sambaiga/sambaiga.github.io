---
layout: post
title: Artificial intelligence (AI) and Earth Observation (EO) for Computation Sustainability
subtitle: Artificial intelligence (AI) and Earth Observation (EO)
subsubtitle: Opportunity for Computation Sustainability
date: 2020-06-20
description: This post introduces how Earth Observation (EO), EO data sources and Artificial Intelligence (AI) could be used for Computational Sustainability.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/eo-posts/Multispectral_bands.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
    Multispectral satellite image bands
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/eo-posts/EO_AI.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
    AI capability for object detection and using computer vision techniques for multiband satellite images
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/eo-posts/ai_ready.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/eo-posts/change_detection.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
