...
Now we have a streamlit app running. The following post will demonstrate how to connect the streamlit app to the database and visualise a significantly larger dataset on streamlit.