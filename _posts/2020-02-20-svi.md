...
subtitle: Stochastic Variational Inference (SVI)
subsubtitle: stochastic gradient based algorithm for varitaional inference
date: 2020-01-20
description: This post introduce  stochastic gradient based algorithm (SVI) used in practise to do variational inference under mean filed assumptions. 
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/svi-post/VI.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/svi-post/distribution.png' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
